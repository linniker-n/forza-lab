...
// Last sync: 2026-06-06T06:18:13.645Z | Adicionados: 05/06
...
export const COMMUNITY_TUNES: SpreadsheetTune[] = [
  ...
  tune("b29", "Nissan 240SX 1993 Ω", "B", "Pista/Sprint", "171666252", "ZVTCJAU", undefined, { isNew: true }),
  ...
  tune("a15", "Ferrari F355 Berlinetta Ω", "A", "Pista/Allround", "113155885", "TTH Bagel", undefined, { isNew: true }),
  ...
  tune("a39", "Lotus Emira", "A", "Pista/Allround", "641459657", "RcR StriKer"),
  ...
  tune("a51", "Subaru STI 2019", "A", "Pista/Allround", "115358635", "SlowBakedPanda"),
  ...
  tune("s_116", "Ferrari Laferrari", "S1", "Pista/Sprint", "253518947", "Nalak28", "Não recomendado para pista molhada"),
  tune("s_117", "Ferrari Roma", "S1", "Pista/Allround", "140260193", "LetzeLU"),
  ...
  tune("s_127", "Koenisegg Agera RS", "S1", "Pista/Allround", "160703091", "KapienPL", undefined, { isNew: true }),
  tune("s_128", "Koenisegg Agera", "S1", "Pista/Allround", "109025162", "ZVTCJAU"),
  tune("s_129", "Koenisegg ONE:1", "S1", "Pista/Allround", "515198419", "Noa Miyako", undefined, { isNew: true }),
  tune("s_130", "Lamborghini Centenario", "S1", "Pista/Allround", "186844511", "theEBTwarrior"),
  tune("s_131", "Lamborghini Countach 2021", "S1", "Pista/Allround", "971170140", "ESV Rapture"),
  tune("s_132", "Lamborghini Diablo GTR Ω", "S1", "Rally", "183038814", "ZVTCJAU", undefined, { isNew: true }),
  tune("s_133", "Lamborghini Huracan Evo Ω", "S1", "Pista/Allround", "848111494", "LetzeLU"),
  tune("s_134", "Lamborghini Huracan STO", "S1", "Pista/Allround", "174155902", "skyinfin"),
  tune("s_135", "Lamborghini Sterrato", "S1", "Rally", "167731877", "ShaggyScroll660", "Bastante instável em pistas com muitas elevações"),
  tune("s_136", "Lancia Delta S4", "S1", "Rally", "165795412", "LetzeLU"),
  tune("s_137", "Lotus Exige 2018", "S1", "Pista/Allround", "799133542", "CybrexzzZ"),
  tune("s_138", "Lotus Elise GT1", "S1", "Rally", "189772072", "Noa Miyako"),
  tune("s_139", "Mazda 787B Ω", "S1", "Pista/Allround", "128172950", "RASLockRe7"),
  tune("s_140", "Mazda Miata EF Ω", "S1", "Pista/Allround", "115749728", "CybrexzzZ"),
  tune("s_141", "Mazda Miata EF Ω", "S1", "Rally", "128928248", "Rocklxd", "Mais veloz que os demais mas menos grip no asfalto"),
  tune("s_142", "Mclaren 12C", "S1", "Pista/Allround", "147708012", "SeeyeahBoss"),
  tune("s_143", "Mclaren 620R Ω", "S1", "Pista/Allround", "264811446", "TonyTKS", "S1 AWD mais forte do jogo"),
  tune("s_144", "Mclaren 650S Spider", "S1", "Pista/Allround", "120449939", "HenRSBR"),
  tune("s_145", "Mclaren 765LT", "S1", "Pista/Allround", "812139843", "TheDannny"),
  ...
  tune("s_203", "Hennessey Venom F5", "S2", "Pista/Sprint", "881844498", "SPIRIT8821", "Muito forte em corridas específicas", { isNew: true }),
  ...
  tune("s_209", "Mazda 787B Ω", "S2", "Pista/Allround", "558127738", "TonyTKS"),

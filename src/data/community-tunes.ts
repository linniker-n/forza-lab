...
// Last sync: 2026-06-05T18:39:31.670Z | Adicionados: 04/06
...
export const COMMUNITY_TUNES: SpreadsheetTune[] = [
  ...
  tune("b38", "Acura Integra Type R 2001", "B", "Pista", "522769491", "Papa Josh1591"),
  tune("b39", "Dodge Dart 1968", "B", "Pista", "127326115", "VNX Codcaos"),
  tune("b40", "Holden Torana A9X", "B", "Pista", "249407066", "ThankfulBard261"),
  tune("b41", "Honda Civic RS 1974", "B", "Allround", "112404508", "ESV Mars"),
  tune("b42", "Honda Civic RS 1974", "B", "Allround", "100056885", "Rexazr"),
  tune("b43", "Honda Civic Type R 1997", "B", "Pista", "136399449", "EMW Dave"),
  tune("b44", "Shelby Daytona", "B", "Allround", "151488877", "Inayamei"),
  tune("b45", "International Scout 800A 1970", "B", "Rally", "840347205", "Cast Haste"),
  tune("b46", "RAM 2500 Power Wagon", "B", "Rally", "181630398", "GhostMan2117"),
  tune("b47", "Toyota FJ40", "B", "Rally", "154652753", "Korrrupt EU"),
  tune("b48", "International Scout 800A 1970", "B", "Cross", "178406104", "Rocklxd"),
  tune("b49", "RAM 2500 Power Wagon", "B", "Cross", "744406104", "Nep0sha"),
  tune("b50", "Honda Civic Type R 1997", "B", "Allround", "112489433", "Grandma Driving"),
  tune("b51", "Honda S2000", "B", "Allround", "798920769", "ThankfulBard261"),
  tune("b52", "Subaru Impreza 22B STI", "B", "Allround", "255323448", "ThankfulBard261"),
  tune("b53", "Jeep CJ5", "B", "Rally", "133421194", "GhostMan2117"),
  tune("b54", "Nissan Pulsar GTI-R 1990", "B", "Rally", "126773170", "Korrrupt EU"),
  tune("b55", "Dodge Dart 1968", "B", "Pista", "350387335", "SepiSP4"),
  tune("b56", "Ford De Luxe Coupe 1932", "B", "Pista", "181192570", "Egao no hana"),
  tune("b57", "Holden Torana A9X", "B", "Pista", "126495330", "SepiSP4"),
  tune("b58", "Holden Torana A9X", "B", "Pista", "758142846", "Egao no hana"),
  tune("b59", "Honda Civic RS 1974", "B", "Pista", "363966198", "SepiSP4"),
  tune("b60", "Honda Civic RS 1974", "B", "Pista", "171916434", "Akumanozero"),
  tune("b61", "International Scout 800A 1970", "B", "Pista", "131879247", "Akumanozero"),
  tune("b62", "Nissan Pulsar GTI-R 1990", "B", "Allround", "182428587", "SepiSP4"),
  tune("b63", "Shelby Daytona", "B", "Pista", "180472249", "SepiSP4"),
  tune("b64", "Shelby Daytona", "B", "Pista", "660779402", "SepiSP4"),
  tune("b65", "International Scout 800A 1970", "B", "Rally", "971039236", "SepiSP4"),
  tune("b66", "International Scout 800A 1970", "B", "Rally", "678698218", "SepiSP4"),
  tune("b67", "International Scout 800A 1970", "B", "Cross", "422114880", "SepiSP4"),
  tune("b68", "RAM 2500 Power Wagon", "B", "Cross", "142545394", "SepiSP4"),
  tune("b69", "Acura Integra Type R 2001", "B", "Pista", "109616165", "SepiSP4"),
  tune("b70", "Chevrolet Chevelle SS 1970", "B", "Pista", "131114657", "SepiSP4"),
  tune("b71", "Lamborghini Miura 1967", "B", "Pista", "464578200", "Akumanozero"),
  tune("b72", "Mini Cooper S 1965", "B", "Pista", "142211005", "SepiSP4"),
  tune("b73", "Mitsubishi Eclipse 1995", "B", "Allround", "837846590", "SepiSP4"),
  tune("b74", "Nissan Skyline GT-R 1993", "B", "Allround", "129233198", "Mustuff124"),
  tune("b75", "Plymouth Barracuda Hemi 1971", "B", "Pista", "944053942", "VNX Codcaos"),
  tune("b76", "Renault Clio Williams 1993", "B", "Allround", "130092829", "SepiSP4"),
  tune("b77", "Shelby Daytona", "B", "Pista", "401358590", "Egao no hana"),
  tune("b78", "Datsun 510 1970", "B", "Rally", "142696843", "SepiSP4"),
  tune("b79", "Ford Bronco 1975", "B", "Rally", "621070704", "yeetlur"),
  tune("b80", "Ford Bronco 1975", "B", "Rally", "512135056", "SepiSP4"),
  tune("b81", "Ford F-100 1956", "B", "Rally", "543873563", "Mustuff124"),
  tune("b82", "Ford F-100 1956", "B", "Rally", "150426978", "Egao no hana"),
  tune("b83", "Honda Civic RS 1974", "B", "Rally", "395944030", "SepiSP4"),
  tune("b84", "Lamborghini Miura 1967", "B", "Rally", "252174621", "Korrrupt EU"),
  tune("b85", "Mini Cooper S 1965", "B", "Rally", "126741880", "Ausax"),
  tune("b86", "Nissan Pulsar GTI-R 1990", "B", "Rally", "842451514", "Korrrupt EU"),
  tune("b87", "Toyota FJ40", "B", "Rally", "175276920", "yeetlur"),
  tune("b88", "Ford Super Duty F-450", "B", "Cross", "682007551", "SepiSP4"),
  tune("b89", "Toyota FJ40", "B", "Cross", "157141010", "SepiSP4"),
  tune("b90", "Ford Bronco 1975", "B", "Cross", "177322128", "SepiSP4"),
